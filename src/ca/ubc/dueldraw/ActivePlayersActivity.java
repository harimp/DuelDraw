...
public class ActivePlayersActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (app.playerListReady) {
			...
			values = new String[] { "Player 1", "Player 2", "Player 3",
					"Player 4", "Player 5" };
		}
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapter, View v,
				...
				String opponentSelected = (String) adapter
						.getItemAtPosition(position);
				app.opponentID = opponentSelected; // set opponentID in
													// application class

				app.sendMessage("G" + app.opponentID); // send challenge

				pd = ProgressDialog.show(ActivePlayersActivity.this,
